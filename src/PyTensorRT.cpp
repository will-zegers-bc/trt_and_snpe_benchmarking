...
PYBIND11_MODULE(PyTensorRT, m)
{
    m.doc() = "TensorRT Inference Engine";
    pybind11::class_<TensorRT::NetConfig>(m, "NetConfig")
        .def(pybind11::init<std::string, std::string, std::string, int, int, int, int, int>(),
        ...
        .def_readwrite("input_channels", &TensorRT::NetConfig::inputWidth)
