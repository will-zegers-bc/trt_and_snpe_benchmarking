...
def convert_img(src_img,dest_img,size,resize_type):
    print("Scaling to square: " + src_img)
    print(src_img)
    __resize_square_to_jpg(src_img,dest_img,size,resize_type)

    print("Image mean: " + dest_img)
    print(dest_img)
    mean_rgb=(128,128,128)
    __create_raw_incv3(dest_img,mean_rgb,128,False,False)
